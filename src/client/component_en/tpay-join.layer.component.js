...
Tw.TPayJoinLayerPopup.prototype = {
  ...
  _onGoSubmain: function () {
    this._historyService.goLoad('/en/membership/submain');
  },
  ...
  _onClickSetup: function () {
    // T페이 설치 페이지 이동
    this._popupService.closeAllAndGo('/en/product/apps/app?appId=TW50000015');
  },
  /**
  ...
  _onCloseBtn: function () {
    this._popupService.closeAllAndGo('/en/membership/submain');
  }
};