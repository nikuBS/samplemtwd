...
Tw.CommonMemberLogin.prototype = {
  ...
  _init: function (target) {
    ...
    this._goLoad(Tw.NTV_CMD.LOGIN, '/en/common/tid/login?target=' + encodeURIComponent(target) +
  ...
  _goLoad: function (nativeCommand, url, callback) {
    if ( Tw.BrowserHelper.isApp() ) {
      this._nativeService.send(nativeCommand, {type: '0' , isForeigner: 'Y'}, callback);
    } else {
