/**
 * FileName: myt.joinService.contractTerminalInfo.twibro.js
 * Author: 김명환 (skt.P130714@partner.sk.com)
 * Date: 2018.07.24
 * Info:
 */

Tw.MytJoinServiceContractTerminalInfoTwibro = function (rootEl, resData) {
  this.thisMain = this;
...
Tw.MytJoinServiceContractTerminalInfoTwibro.prototype = {
  _init: function () {
    Tw.Logger.info('[초기화]');
