...
Tw.MyTBillHotBill.prototype = {
  ...
  _openFamilyMemberSelect: function () {
    ...
    var members = [
      { 'attr': 'href="#" onclick="alert(\'a\');"', text: '010-12**-81**(GALAXY S7 32G) 1' },
      { 'attr': 'href="#"', text: '010-12**-81**(GALAXY S7 32G) 234' },
      { 'attr': 'href="#"', text: '010-12**-81**(GALAXY S7 32G) 5' },
      { 'attr': 'href="#"', text: '010-12**-81**(GALAXY S7 32G) 67' },
      { 'attr': 'href="#"', text: '010-12**-81**(GALAXY S7 32G) 89010' }
    ];
