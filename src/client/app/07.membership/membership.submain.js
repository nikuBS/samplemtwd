...
Tw.ProductRoamingFiGuide.prototype = {
  ...
  _nearBrandRequest: function(){
    this._apiService.request(Tw.API_CMD.BFF_11_0017, {keyword : ''}).done($.proxy(this._handleSuccessSearchCountry, this));
  },
