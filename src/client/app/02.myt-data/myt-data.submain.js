...
Tw.MyTDataSubMain.prototype = {
    ...
    if (this.data.svcInfo.svcAttrCd === 'M2') {
      ...
      if (Tw.BrowserHelper.isApp()) {
        ...
        this._popupService.openModalTypeA(
          Tw.ALERT_MSG_COMMON.T_WORLD_APP_MOVED.TITLE,
          Tw.ALERT_MSG_COMMON.T_WORLD_APP_MOVED.MSG,
          Tw.ALERT_MSG_COMMON.T_WORLD_APP_MOVED.BUTTON,
          $.proxy(this._onOpenTworldMovedAlert, this),
          $.proxy(this._onConfirmTworldMovedAlert, this),
          this
        );
      }
    } else {
  ...
  _onOpenTworldMovedAlert: function($layer) {
    $layer.find('.pos-left .tw-popup-closeBtn').on(
      'click',
      $.proxy(function() {
