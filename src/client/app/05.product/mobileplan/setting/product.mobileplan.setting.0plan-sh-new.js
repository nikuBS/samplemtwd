 ...
 */
 Tw.ProductMobileplanSetting0planShNew = function(rootEl, prodId, displayId, currentOptionProdId) {
  ...
  Tw.ProductMobileplanSetting0planShNew.prototype = {
    ...
    //테스트 부가서비스 가입 목록  실 배포시 삭제 ◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎◼︎ 11111
    ...
    .done($.proxy((res)=>{
    console.log("</br</br>================6621 : "+res.result.isAdditionUse)
    }));
