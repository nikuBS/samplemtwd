 ...
 */
 Tw.ProductMobileplanSetting0planNew = function(rootEl, prodId, displayId, currentOptionProdId, secondProdJoinYN, isUnderAge19) {
    // 컨테이너 레이어 선언
    ...
    this._objsecondProdJoinYN = secondProdJoinYN;  //조건에 해당하는 부가서비스 가입여부 obj
  ...
  Tw.ProductMobileplanSetting0planNew.prototype = {
    ...
    //  0플랜_FLO앤데이터[NA00006634]가입, FLO 앤 데이터[NA00006520]미가입일경우
    //  0플랜_wavve앤데이터[NA00006622]가입, wavve 앤 데이터[NA00006520]미가입일 경우
    //  0플랜_WAVVE_FLO_70%[NA00007298]가입, ( FLO 앤 데이터[NA00006520] or wavve 앤 데이터[NA00006520] ) 미가입일경우

    if ( this._isUnderAge19 ) {

      var objZerg =   this._objsecondProdJoinYN;

      if(objZerg.Yn_6634 === 'Y' && objZerg.Yn_6520 ==='N' && objZerg.Yn_6622 ==='Y' && objZerg.Yn_6577 ==='N' && objZerg.Yn_7298 ==='Y'){
   ...
   _secondProdChk: function(resp){
    ...
    _openAddCertifyPopup: function () {
      ...
      popupOptions = {
        ...
        editor_html : '<div class="tod-popbenf-inwrap"><img src="'+Tw.Environment.cdn+'/img/product/img-sms-flowavve2_m.png" alt="사용을 원하시는 FLO 앤 데이터, wavve 앤 데이터 부가서비스 가입을 하셔야 할인 혜택이 적용됩니다." class="vt" style="width:100%"></div>',
        bt: [
          {
