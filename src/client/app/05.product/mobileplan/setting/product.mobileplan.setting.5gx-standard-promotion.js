/**
 * @file 상품 > 모바일요금제 > 설정 > 5Gx 스탠다드 프로모션
 ...
 */
Tw.ProductMobileplanSetting5gxStandardPromotion = function(rootEl, prodId, settingInfo) {
  // 컨테이너 레이어 선언
...
Tw.ProductMobileplanSetting5gxStandardPromotion.prototype = {
