...
//         // element.find('.tod-mls-link').children('.link-plan').attr('href', '/recommend/product');
...
//         //     $('.tod-mls-card > div').eq(0).fadeOut(time);
//         //     $('.tod-mls-card > div').eq(1).fadeIn(time);
