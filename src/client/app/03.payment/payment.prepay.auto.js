...
Tw.PaymentPrepayAuto = function (rootEl) {
...
Tw.PaymentPrepayAuto.prototype = {
  ...
  _goAutoPrepay: function () {
    this._apiService.request(Tw.API_CMD.BFF_07_0086, {})
      .done($.proxy(this._getAutoPrepayAmountSuccess, this))
      .fail($.proxy(this._getAutoPrepayAmountFail, this));
  },
  _getAutoPrepayAmountSuccess: function () {
    this._getAutoPrepayInfo('#step1-auto-prepay');
  },
  _getAutoPrepayAmountFail: function () {
