...
Tw.MyTJoinPhoneNumChgAlarm.prototype = {
  ...
  _onclickBtnOk: function(){
    ...
    var maxDate = this.$btnPeriod.data('max-date').toString();
    maxDate = Tw.DateHelper.getDiffByUnit(notiEndDt, maxDate, 'days') > 0 ? maxDate : notiEndDt;
    var param = {
      notiEndDt : Tw.DateHelper.getShortDateWithFormat(maxDate, 'YYYYMMDD'),
