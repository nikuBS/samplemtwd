...
Tw.NetFunnelInfo = [
  {
    actionId: 'act-myt-data_submain',
    target: '/myt-data/submain'
  }, {
    actionId: 'act-myt-fare_submain',
    target: '/myt-fare/submain'
  }, {
    actionId: 'act-myt-join_submain',
    target: '/myt-join/submain'
  }, {
    actionId: 'act-tevent_ing',
    target: '/tevent/ing'
  }, {
    actionId: 'act-product_combinations',
    target: '/product/combinations'
  }, {
    actionId: 'act-product_wireplan',
    target: '/product/wireplan'
  }, {
    actionId: 'act-product_mobileplan-add',
