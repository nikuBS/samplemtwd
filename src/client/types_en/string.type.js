...
Tw.MONTHS = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];

Tw.WEEKDAYS = ['Sun', 'Mon', 'Tue', 'Web', 'Thu', 'Fri', 'Sat'];
...
Tw.ALERT_MSG_HOME = {
  NEW_LINE: 'Your line has been added to T world.',
...
Tw.ALERT_MSG_MYT_JOIN = {
  ...
  ALERT_2_A200: {
    TITLE: 'Notice',
    MSG:
      'You may use T world after setting up your passcode.<br>' +
      'Would you like to cancel setting up your passcode?<br>' +
      '(If you tap on the confirm button, you will be logged out and directed to the main page)'
  },
...
Tw.ALERT_MSG_AUTH = {
  ALERT_4_A5: 'Would you like to change your main line to the selected line?',
  ALERT_4_A6: '기준회선으로 변경 되었습니다.',
  L02: 'You have changed your main line.',
  ...
  L04: '변경 내용을 저장하시겠습니까?',
  L05: 'Would you like to remove the selected line?',
...
Tw.MYT_JOIN_CUSTPASS = {
  AUTO_A04: 'Please enter passcode.',
  EMPTY_PWD: 'Please enter more than 6 digits.',
  ONLY_PWD: 'Only numbers allowed.',
  FAIL_PWD: 'Passcode incorrect. \n Please try again.',
  BLOCKED_PWD: 'You have entered invalid passcode more than 5 times. <br>' + 'Please visit an SK Telecom store and to reset your passcode. '
};
