...
Tw.API_CMD = {
  ...
  BFF_05_0216: { path: '/core-modification/:version/mobile-join-info', method: Tw.API_METHOD.GET },
  // [OP002-6291]
  ...
  // 영문화 신규API 추가
  BFF_05_0223: { path: '/core-bill/:version/global-hotbills'        , method: Tw.API_METHOD.GET },
  BFF_05_0225: { path: '/:version/my-t/global-balances'        , method: Tw.API_METHOD.GET },  
  BFF_05_0226: { path: '/core-bill/v1/global-bill-pay/bills'        , method: Tw.API_METHOD.GET },
  BFF_05_0229: { path: '/core-bill/v1/global-bill-pay/bills-submain', method: Tw.API_METHOD.GET },
  ...
  BFF_10_0202_EN: { path: '/core-product/:version/submain/global-grpprods', method: Tw.API_METHOD.GET },
...
Tw.AJAX_CMD = {
  ...
  GET_TSHOP_IMG_LIST: { path: '/en/api/store/store/images', method: Tw.API_METHOD.GET, url: '' }
};
