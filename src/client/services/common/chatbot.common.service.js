...
Tw.ChatbotCommonService.prototype = {
    ...
    */
    ...
    _mlsGreetingRangkingUnshift: function (keywordText, mlsGreetingRangking, greetingKeywords, mlsGreetingTextType) {
        ...
        Tw.Logger.info('[chatbot.service] [_mlsGreetingRangkingUnshift] mlsGreetingRangking : ', mlsGreetingRangking);
        Tw.Logger.info('[chatbot.service] [_mlsGreetingRangkingUnshift] greetingKeywords : ', greetingKeywords);
        Tw.Logger.info('[chatbot.service] [_mlsGreetingRangkingUnshift] mlsGreetingTextType : ', mlsGreetingTextType);
            ...
            greetingKeywords.forEach(function (row) {
                if( row.keyword && row.type && row.keyword === keywordText && row.type === mlsGreetingTextType && mlsGreetingRangking ) {
                    ...
                    if ( _this._checkGreetingDate(row) ) {
                        ...
                        Tw.Logger.info('[chatbot.service] [_mlsGreetingRangkingUnshift] mlsGreetingRangking unshift success', '');
                        return;
                    }
                }
            });
