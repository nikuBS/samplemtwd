...
Tw.API_CMD = {
  ...
  // HOME
  BFF_04_0001: { path: '/core-membership/v1/card/homeinfo', method: Tw.API_METHOD.GET },
  ...
  BFF_05_0064: { path: '/core-bill/v1/use-contents/hist-requests', method: Tw.API_METHOD.GET },
  BFF_05_0066: { path: '/core-bill/v1/use-contents/limit-requests', method: Tw.API_METHOD.GET },
  BFF_05_0067: { path: '/core-bill/v1/use-contents/limit-up', method: Tw.API_METHOD.POST },
  ...
  BFF_05_0079: { path: '/core-bill/v1/micro-pay/hist-requests', method: Tw.API_METHOD.POST },
  BFF_05_0080: { path: '/core-bill/v1/micro-pay/requests', method: Tw.API_METHOD.GET },
  BFF_05_0081: { path: '/core-bill/v1/micro-pay/requests', method: Tw.API_METHOD.POST },
  BFF_05_0082: { path: '/core-bill/v1/micro-pay/auto-set', method: Tw.API_METHOD.POST },
  BFF_05_0083: { path: '/core-bill/v1/micro-pay/requests', method: Tw.API_METHOD.PUT },
  BFF_05_0085: { path: '/core-bill/v1/micro-pay/password-status', method: Tw.API_METHOD.GET },
  ...
  BFF_05_0144: { path: '/core-product/v1/services/combinations/:args0/terminations', method: Tw.API_METHOD.DELETE },
  ...
  BFF_05_0176: { path: '/core-bill/v1/micro-pay/requests-limit-down', method: Tw.API_METHOD.POST },
  BFF_05_0177: { path: '/core-bill/v1/use-contents/limit-down', method: Tw.API_METHOD.POST },
  ...
  BFF_05_0184: { path: '/core-modification/v1/number-change/search', method: Tw.API_METHOD.GET },
  BFF_05_0185: { path: '/core-modification/v1/number-change/process', method: Tw.API_METHOD.POST },
  BFF_05_0195: { path: '/core-modification/v1/longterm-phone-pause', method: Tw.API_METHOD.PUT },
  ...
  BFF_07_0071: { path: '/core-bill/v1/micro-prepay/hist-requests', method: Tw.API_METHOD.GET },
  BFF_07_0073: { path: '/core-bill/v1/micro-prepay/requests', method: Tw.API_METHOD.GET },
  BFF_07_0074: { path: '/core-bill/v1/micro-Prepay/process', method: Tw.API_METHOD.POST },
  BFF_07_0076: { path: '/core-bill/v1/micro-prepay/auto-process', method: Tw.API_METHOD.POST },
  BFF_07_0077: { path: '/core-bill/v1/micro-prepay/auto-delete', method: Tw.API_METHOD.POST },
  BFF_07_0078: { path: '/core-bill/v1/use-contents-prepay/hist-requests', method: Tw.API_METHOD.GET },
  BFF_07_0079: { path: '/core-bill/v1/use-contents-prepay/auto-hist', method: Tw.API_METHOD.GET },
  BFF_07_0081: { path: '/core-bill/v1/use-contents-prepay/requests', method: Tw.API_METHOD.GET },
  BFF_07_0082: { path: '/core-bill/v1/use-contents-prepay/process', method: Tw.API_METHOD.POST },
  BFF_07_0083: { path: '/core-bill/v1/use-contents-prepay/auto-process', method: Tw.API_METHOD.POST },
  BFF_07_0084: { path: '/core-bill/v1/use-contents-prepay/auto-delete', method: Tw.API_METHOD.POST },
