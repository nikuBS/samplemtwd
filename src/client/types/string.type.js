...
Tw.REFILL_COUPON_CONFIRM = {
  ...
  CONTENTS_REFILL: '리필된 데이터(또는 음성)는 당월에 한해 사용 가능하며,<br />리필 이후 요금제 변경시 사용하실 수 없습니다.<br />※리필하기는 신청 후 취소가 불가능합니다.',
...
Tw.ALERT_MSG_PRODUCT = {
  ...
  ALERT_3_A100: { TITLE: '미성년자 옵션 선택 안내', MSG: 'FLO 앤 데이터 월정액 무료 / POOQ 앤 데이터 월정액 무료 이용을 원하실 경우 고객센터 또는 대리점을 통해 법정대리인 동의 후 이용해주시기 바랍니다.\n(이미 해당 상품을 유료로 이용중인 고객님께서는 옵션 선택이 가능합니다.)' },
