...
Tw.MYT_JOIN_SUSPEND = {
  ...
  LONG: {
    MILITARY: {
      TITLE: '구비서류 첨부 안내',
      TIP: '- 병적증명서(지방병무청, 시군구 읍면동 주민센터 등에서 발급), 입영 사실 기재 주민등록초본 or 입영통지서, 선발 통지서 등 병역법 시행규칙에서 정한 서식과 신분증 2종 필수 제출입니다.<br />' +
    ...
    ABROAD: {
      TITLE: '구비서류 첨부 안내',
      TIP: '- 항공권 사본(편도, 왕복 모두 인정/전자항공권 인정), 출입국에 관한 사실 증명서(출입국 관리사무소, 인터넷 발급 인정) 등 해외체류입증 서류 필수 제출입니다.' +
