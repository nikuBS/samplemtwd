...
Tw.ALERT_MSG_MYT_JOIN = {
  ...
  ALERT_2_A200: { TITLE: '알림', MSG: '고객비밀번호 설정 후 T월드를 이용할 수 있습니다.<br>' +
      '비밀번호를 설정 취소 하시겠습니까?<br>' +
      '(확인 버튼 터치시 로그아웃 후 메인으로 이동됩니다.)' },
  ALERT_2_A201: { TITLE: '알림', MSG: 'B끼리 무료통화 대상자입니다.' },
  ALERT_2_A209: { TITLE: '알림', MSG: '고객보호 비밀번호 N회 잘못 입력하셨습니다.<br>' +
      '5회 이상 잘못 입력한 경우 SK텔레콤 지점에 방문하여 초기화 후 이용해 주셔야 합니다.' },
...
Tw.ALERT_MSG_PRODUCT = {
  ...
  ALERT_3_A20: { TITLE: '알림', MSG: '로그인이 필요합니다.'},
...
Tw.MYT_JOIN_CUSTPASS = {
  ...
  BLOCKED_PWD: '고객보호 비밀번호를 5회 이상 잘못 입력하셨습니다.<br>' +
    'SK텔리콤 지점에 직접 방문하여 초기화 후 이용해 주시기 바랍니다.'
};
