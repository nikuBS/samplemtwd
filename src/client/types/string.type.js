...
Tw.ALERT_MSG_PRODUCT = {
  ...
  ALERT_3_A62: { TITLE: '해지 시 유의사항을 모두 확인하였으며, 선택하신 상품을 해지하시겠습니까?', MSG: '고객님께서는 T끼리온가족할인 가입되어있습니다.\n해지 시 그룹 탈퇴 및 2회선 미만으로 T끼리온가족그룹이 자동 해지됩니다.', BUTTON: '해지하기' },
