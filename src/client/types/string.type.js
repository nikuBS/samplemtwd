...
Tw.ALERT_MSG_COMMON = {
  ...
  CHANGE: '변경하시겠습니까?',
  BIOMETRICS_REGISTER_FAIL: '등록에 실패하였습니다.',
...
Tw.ALERT_MSG_MYT_JOIN = {
  ...
  ALERT_2_A200: {
    TITLE: '알림',
    MSG:
      '고객비밀번호 설정 후 T월드를 이용할 수 있습니다.<br>' +
...
Tw.ALERT_MSG_PRODUCT = {
  ...
  ALERT_3_A32: { TITLE: '파일당 제한용량(2MB)을 초과하여 첨부파일을 등록할 수 없습니다. 다시 확인해 주세요.', MSG: '' },
...
Tw.ALERT_MSG_AUTH = {
  ...
  L02: '기준회선이 변경 되었습니다.',
  L02_1: '\'추가 가능한 회선\'에서 회선을 추가하시면 T월드를 이용하실 수 있습니다.',
