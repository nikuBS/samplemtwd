...
Tw.MYT_DATA_GIFT = {
  ...
  GFT0004: {
    CONTENT1: '선물하시는 고객님의 기본 잔여데이터가 500MB 미만입니다.<br>',
    CONTENT2: '선물가능 데이터 한도 : ',
    CONTENT3: '남음'
  },
...
Tw.PRODUCT_TFAMILY_ERROR = {
  NO_INFO: '정보없음',
  LESS_LENGTH: '휴대폰번호 자릿수를 확인해주세요. (9~11자리)',
  WRONG_NUM: '휴대폰번호가 올바르지 않습니다.',
  WRONG_BIRTH: '생년월일 자릿수를 확인해주세요. (8자리)',
