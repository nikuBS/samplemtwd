...
Tw.AUTO_PAY_INFO = {
  TITLE: '자동 선결제란',
  CONTENTS_MICRO: '자동 선결제 신청 시 설정된 금액이 자동으로 선결제됩니다.' + '<br/><br/>' + '잔여한도 걱정없이 소액결제를 이용하세요.',
...
Tw.PREMTERM_MSG = {
  LESS_180: '프리미엄패스1 가입일 포함 181일 이전 요금제 하향 시 서비스가 자동해지 되며, 서비스 가입기간에 따라 차액정산금 및 해지위약금이 부과됩니다.',
