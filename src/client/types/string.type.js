...
Tw.MYT_DATA_GIFT = {
  GFT0001: '고객님은 선물하기 불가능한 요금제이시거나, 현재 선물하기가 불가능한 상태입니다.',
  GFT0003: '선물하시는 고객님의 선물하기 횟수가 초과 되었습니다. (회선당 월2회까지 선물하기 가능)',
  GFT0004: {
    CONTENT1: '선물하시는 고객님의 기본 잔여데이터가 500MB 미만입니다.',
    CONTENT2: '선물가능 데이터 한도 : ',
    CONTENT3: '남음'
  },
  GFT0005: '미성년자 고객님은 T끼리 데이터 선물하기 서비스를 이용하실 수없습니다.',
  GFT0013: '시스템상의 오류로 현재 T끼리 데이터 선물하기 서비스를 이용하실 수없으니, 잠시 후 이용해주세요.',
  DEFAULT: ''
}
