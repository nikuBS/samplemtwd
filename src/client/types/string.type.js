...
Tw.REFILL_COUPON_CONFIRM = {
  ...
  // OP002-3518 [myT] (W-1908-111-01) T월드 내 '데이터 리필하기' 관련 설명 수정보완 요청 OP002-3554 Start
  // CONTENTS_REFILL: '리필된 데이터는 당월에 한해 사용 가능하며, 등록 즉시 사용이 시작되어 취소 불가능합니다.',
  CONTENTS_REFILL: '리필된 데이터(또는 음성)는 당월에 한해 사용 가능하며, 리필 이후 요금제 변경시 사용하실 수 없습니다.<br />※리필하기는 신청 후 취소가 불가능합니다.',
  // OP002-3518 [myT] (W-1908-111-01) T월드 내 '데이터 리필하기' 관련 설명 수정보완 요청 OP002-3554 End
  CONFIRM_REFILL: '리필하기',
...
Tw.REFUND_ACCOUNT_INFO = {
  TITLE: '환불계좌란',
  CONTENTS: '이중납부가 되는 경우 환불계좌로 자동 환불 처리해 드립니다.' + '<br/>' + '본인명의의 계좌로만 신청 가능합니다.'
};

Tw.SMS_INFO = {
  TITLE: '문자 발송여부란',
  CONTENTS:
    '지로납부 및 입금전용계좌납부 고객에게 입금전용계좌 SMS서비스를 제공합니다.' + '<br/><br/>' + '문자 발송여부와 입금전용계좌 은행을 선택해 주세요.'
};

Tw.AUTO_PAY_INFO = {
  TITLE: '자동 선결제란',
  CONTENTS_MICRO: '자동 선결제 신청 시 설정된 금액이 자동으로 선결제됩니다.' + '<br/><br/>' + '잔여한도 걱정없이 휴대폰 결제를 이용하세요.',
  CONTENTS_CONTENTS: '자동 선결제 신청 시 설정된 금액이 자동으로 선결제됩니다.' + '<br/><br/>' + '잔여한도 걱정없이 콘텐츠 이용료를 이용하세요.'
};
...
Tw.AMOUNT_INFO = {
  TITLE: '금액정보란',
  MICRO_CONTENTS:
    '기준금액 및 선결제 금액은 이용한도의 최대 90%금액까지 설정이 가능합니다.' +
    '<br/><br/>' +
    '휴대폰 결제 이용금액이 고객님께서 설정한 [기준금액] 초과 시점에 [선결제 금액] 만큼 자동 결제됩니다.',
  CONTENTS_CONTENTS:
    '기준금액 및 선결제 금액은 이용한도의 최대 90%금액까지 설정이 가능합니다.' +
    '<br/><br/>' +
    '콘텐츠 이용료 이용금액이 고객님께서 설정한 [기준금액] 초과 시점에 [선결제 금액] 만큼 자동 결제됩니다.'
};
...
Tw.NON_PAYMENT = {
  ...
  SUSPENSION: {
    ...
    CONTENT_1: '고객님의 미납요금 ',
    CONTENT_2:
      '원이 내일까지 납부 확인되지 않으면 다시 이용이 정지됩니다.' +
      '<br/><br/>' +
...
Tw.ALERT_MSG_COMMON = {
  ...
  T_WORLD_APP_MOVED: {
    ...
    MSG: '선택하신 서비스는<br/>T world app에서만<br/>이용하실 수 있습니다.',
    BUTTON: '이동'
  },
  CERT_SMS_BLOCK: {
...
Tw.ALERT_MSG_HOME = {
  ...
  A02: 'T world에서 제공하는 기본 바로가기로 변경 하시겠습니까?',
  A03: 'MY 바로가기는 최대 20개까지 추가할 수 있습니다.',
  A04: 'MY 바로가기를 모두 제거 했습니다. MY 바로가기를 추가해 T world를 보다 쉽게 사용해 보세요.',
...
Tw.VALIDATE_MSG_MYT_DATA = {
  ...
  V18: '휴대폰번호 자릿수를 확인해 주세요. (10~11자리)',
  GREATER_THAN_CHANGABLE_DATA: '변경 가능 데이터를 초과했습니다.',
  NON_CHANGE_DATA: '변경할 데이터를 입력해주세요.'
};
...
Tw.ALERT_MSG_MYT_FARE = {
  ...
  TEN_MIN: '10원 미만의 금액은 선결제를 하실 수 없습니다.',
  THOUSAND_MIN: '1,000원 미만의 금액은 선결제를 하실 수 없습니다.',
  ...
  ADD_SVC: {
    ...
    BIL0034: '법인실사용자 휴대폰 결제 부가서비스 가입 후 사용 가능합니다.',
  ...
  V47: '미성년자 서비스의 법정대리인 SKT회선만 신청 가능합니다.',
  GET_POINT: '포인트를 조회해 주세요.',
  ...
  CONFIRM_PASSWORD: '변경할 비밀번호와 일치하지 않습니다.',
  CHECK_PASSWORD_LENGTH: '비밀번호는 6자리로 입력해 주세요',
  PASSWORD_ADDITIONAL_INFO:
  ...
  ALERT_2_V1: '받는 분 번호가 올바르지 않습니다.',
  ALERT_2_V2: '계좌번호가 올바르지 않습니다',
  ALERT_2_V3: '은행정보가 올바르지 않습니다.',
  ALERT_2_V4: '카드번호가 올바르지 않습니다.',
  ...
  ALERT_2_V12: '변경할 비밀번호와 일치하지 않습니다.',
  ...
  AUTO_PAYMENT_COMPLETE: {
    TITLE: '변경이 완료되었습니다.</br> {month}월 요금부터 적용됩니다.',
    MSG:  '<li>납부방법: {0}</li>' +
          '<li>예금주: {1}</li>' +
          '<li>계좌정보: {2}</li>'
  },
...
Tw.ALERT_MSG_MYT_JOIN = {
  ...
  ALERT_2_A3: { TITLE: '번호변경 안내 서비스를 해지하시겠습니까?', MSG: '', BUTTON: '종료하기' },
  ...
  ALERT_2_A35: {
    TITLE: '알림',
    MSG: '설치장소 변경 신청이 완료되었습니다. 빠른 시일 내에 신청내역 확인을 위해 상담원이 연락 드리겠습니다. 감사합니다'
  },
  ALERT_2_A36: { TITLE: '알림', MSG: '가입 서비스 변경 신청이 완료 되었습니다 빠른 시일내에 연락 드리도록 하겠습니다' },
  ALERT_2_A39: { TITLE: '알림', MSG: '요금제 변경 알림 서비스가 신청되었습니다.' },
  ALERT_2_A40: { TITLE: '알림', MSG: '요금제 변경 가능일 알림이 해지 되었습니다.' },
  ALERT_2_A61: { TITLE: '알림', MSG: '비밀번호를 확인해 주세요.' },
  ...
  ALERT_2_A200: {
    TITLE: '알림',
    MSG:
      '고객비밀번호 설정 후 T world를 이용할 수 있습니다.<br>' +
      '비밀번호를 설정 취소 하시겠습니까?<br>' +
...
Tw.ALERT_MSG_PRODUCT = {
  ...
  ALERT_3_A100: {
    TITLE: '미성년자 옵션 선택 안내',
    MSG: 'FLO 앤 데이터와 wavve 앤 데이터 모두 70% 할인 옵션 이용을 원하실경우 고객센터 또는 대리점을 통해 법정대리인 동의 후 이용해주시기 바랍니다.\n(이미 해당 상품을 유료로 이용중인 고객님께서는 옵션 선택이 가능합니다.)'
  },
  ...
  FLO_PROMOTION_INFO: {
    TITLE: '프로모션 유의사항 안내',
    MSG: '<em class="tx-bold">고객님께서는 올해 FLO에서 T멤버십 할인 혜택을 받으신 적이 있어 FLO 앤 데이터(플러스) ' +
      '[100원 프로모션] 혜택을 받으실 수 없습니다.</em>\n\n단, 기본요금제 (5GX플래티넘/프라임 요금제, T플랜 맥스/스페셜 요금제) ' +
      '가입에 따른 무료 및 할인혜택은 제공됩니다.\n\n<em class="tx-bold">가입하시겠습니까?</em>',
...
Tw.ALERT_MSG_AUTH = {
  ...
  L02: '기준회선이 변경 되었습니다.',
  L02_1: '\'추가 가능한 회선\'에서 회선을 추가하시면 T world를 이용하실 수 있습니다.',
  ...
  ALERT_4_A8: '이미 등록된 번호이거나, 등록할 수 없는 번호입니다.',
  NICKNAME_VALID: '사용하실 수 없는 닉네임 입니다.',
  NICKNAME_ERROR: '닉네임 수정중 에러가 발생하였습니다.',
  ALERT_4_A9: '선택된 회선이 등록 되었습니다.',
  ALERT_4_50: '선택된 회선의 등록이 해지 되었습니다.',
  ALERT_4_51: '선택된 회선의 닉네임이 변경 되었습니다.',
  ALERT_4_52: '선택하신 회선은 기준회선입니다.\n회선등록 해지 시 다른 회선으로 기준회선이 변경됩니다.\n\n회선등록을 해지 하시겠습니까?',
  ALERT_4_53: '원활한 서비스 이용을 위해서 적어도  1개 이상의 회선은 등록하셔야 합니다.\n\n회선등록을 해지 하시겠습니까?',
...
Tw.NTV_FIDO_REGISTER_TXT = {
  FIDO_ON: '등록된 생체정보가 있습니다.',
  FIDO_OFF: '등록된 생체정보가 없습니다.',
...
Tw.MYT_DATA_FAMILY_CHANGE_DATA_ERRORS = {
  NOT_COMPLETE: '공유가 완료되지 않은 데이터는 변경이 불가능합니다.',
...
Tw.MYT_JOIN_CUSTPASS = {
  ...
  BLOCKED_PWD: '고객보호 비밀번호를 5회 이상 잘못 입력하셨습니다.<br>' + 'SK텔리콤 지점에 직접 방문하여 초기화 후 이용해 주시기 바랍니다.'
};
...
Tw.MYT_JOIN_MGMT_NUMCHG = {
  ...
  ALERT_NO_TARGET: {
    ...
    CONTENTS: '010 전환 번호변경서비스 이용을 원하시면 온라인 T world/지점/대리점을 이용해 주세요.'
  }
};
...
Tw.MYT_JOIN_WIRE_MODIFY_PRODUCT = {
  ...
  PRODUCTBILLLIST: [
    ...
    },
    {
      ...
      child: [
        ['B끼리 무료통화 플러스', '기본요금제', '베이직프리', '정액형요금제', '30요금제', '번호이동'],
        ['패밀리할인제', '실속형할인제'],
        ['WiFi 300 다이렉트', 'B끼리 무료통화 플러스', '기본요금제', '정액형요금제', '실속형요금제']
      ]
    }
  ],
...
Tw.PRODUCT_COMBINE_PRODUCT = {
  ...
  ITEMS: {
    ...
    NA00002040: {
      TITLE: 'T끼리온가족할인',
      EXPLAIN: 'SKT 고객 중 가족 등록 고객에게 합산 가입 년 수에 따라 요금 할인'
    },
    NH00000133: {
      TITLE: 'New온가족플랜',
...
Tw.MEMBERSHIP_URL = {
  ...
  MOVIE: 'http://www.sktmembership.co.kr:90/mobile/tm.jsp?m1=00&targetUrl=/benefit/pick/pickMain.do'
};
...
Tw.BENEFIT_MY_BENEFIT_RAINBOW_POINT = {
  ...
  '2_A16': '법정대리인 정보가 없습니다.'
};

Tw.MYT_JOIN_TB_FREE_BENEFIT = {
  '2053-DAT1G': '데이터500M',
  '2053-LTESF': 'LTE안심옵션'
};
...
Tw.ROAMING_DESC = {
  ...
  HEADER_LOGIN_MSG: '가입된 무선 회선 정보가 확인되지 않습니다.<br>' +
    ...
    '<strong>국가명</strong>으로만 검색하셔도 해당 국가에 따른 서비스 방식을 확인하실 수 있습니다.<br>' +
    '찾고자 하는 휴대폰 모델이 없을 경우 고객센터로 문의 바랍니다.(고객센터 : 114 또는 02-6343-9000)',
  HEADER_LINE_MSG:
    '기본 회선을 무선 회선으로 변경하시면 가입된 휴대폰 정보로 출국 국가별 이용 가능한 로밍 서비스 방식과 요금을 확인하실 수 있습니다.<br>' +
    '찾고자 하는 휴대폰 모델이 없을 경우 고객센터로 문의 바랍니다.(고객센터 : 114 또는 02-6343-9000)',
  BOTTOM_NOTI_LOGIN_MSG: '* 로그인을 하시면 가입된 휴대폰 정보로 확인하실 수 있습니다.',
  BOTTOM_NOTI_PHONE_MSG: '* 고객님은 회선 <strong>미인증 회원</strong>입니다.<br>T world에서 회선 인증 후 이용 가능한 서비스 방식 확인이 가능합니다.'
};
...
Tw.LOGIN_CUS_PW_GUIDE = {
  ...
  CONTENTS: '고객보호 비밀번호 서비스 신청 후 아직 비밀번호를 설정하지 않으셨습니다.',
  INFO: '고객보호 비밀번호 설정 후 정상적인 이용이 가능합니다.',
  BUTTON: '설정하기'
};
...
Tw.ROAMING_DOWNLOAD_URL = {
  ...
  SMART_PARTNER_GUIDE: 'https://cdnm.tworld.co.kr/img/smartphone_Partner.pdf',
...
Tw.PRODUCT_TFAMILY = {
  NO_INFO: '정보없음',
  IS_JOIN: '가입 가능합니다.',
  LESS_LENGTH: '휴대폰번호 자릿수를 확인해 주세요. (9~11자리)',
  WRONG_NUM: '휴대폰번호가 올바르지 않습니다.',
...
Tw.ALERT_MSG_5G = {
  END_NOTI: {
    TITLE: 'VR기기 재고 소진으로 인해<br> ‘5GX VR 팩 카드보드’ 가입이 4월 23일(화) 이후 종료됩니다.',
    MSG: ''
  },
  VRPACK_END: {
    TITLE: 'VR기기 재고 소진으로<br> 5GX VR 팩 기어 부가서비스 가입이 종료되었습니다.',
    MSG: ''
  },
  CARDBOARD_END: {
...
Tw.WIRE_NUMBER_CHANGE = {
  ...
  NOT_ON_SERVICE: '해당 서비스는 사용중인 서비스가 아니므로 변경요청을 할 수 없습니다.',
  ALERT_BROADBAND: {
    TITLE: 'SK브로드밴드 가입 회선입니다.',
    CONTENTS: '전화 106 또는 SK브로드밴드 홈페이지를 이용해 주시기 바랍니다.',
    BUTTON: 'SK브로드밴드 바로가기'
...
// 은행, 카드사 거래상태 체크
Tw.FINANCIAL_VALIDATION = {
  PAYC0090: '계좌이체 대행기관과의 거래가 불안정합니다. 다른 납부방법을 이용하시기 바랍니다.',
  PAYC0091: '계좌이체 은행과의 거래가 불안정합니다. 다른 은행을 이용하시기 바랍니다.',
  PAYC0092: '계좌이체 은행 업무가 개시 전입니다. 개시 이후 이용하시기 바랍니다.',
  PAYE0101: '카드사 승인 거래가 불안정합니다. 다른 카드사를 이용하시기 바랍니다.',
  PAYE0102: '카드승인 대행기관과 거래가 불안정합니다. 다른 납부방법을 이용하시기 바랍니다.'
};
