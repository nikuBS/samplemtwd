...
Tw.MSG_MYT = {
  ...
  BILL_GUIDECHANGE_A12: '[T] 요금안내서의 정보가 변경되었습니다.',
  ...
  BENEFIT: {
    ...
    MEMBERSHIP: {
      LIST: [
        ...
        {
          TITLE: '커플 전용 혜택',
          TEXT: '영화/커피/공연 1+1 혜택을<br/>받고 있습니다.',
          CODE: 'COUPLE'
        },
        {
...
Tw.MSG_RECHARGE = {
  ...
  LIMIT_A01: '이번 달 데이터가 차단 해제 됩니다. 신청하시겠습니까?',
  LIMIT_A02: '다음 달부터 매월 데이터가 차단 해제 됩니다. 신청하시겠습니까?',
  LIMIT_A03: '매월 자동 충전 해제 후 이용 가능합니다.',
  LIMIT_A04: '다음 달부터 매월 데이터가 차단 됩니다. 신청하시겠습니까?',
  LIMIT_A05: '이번 달 데이터가 차단됩니다. 신청하시겠습니까?',
...
Tw.MSG_GIFT = {
  TING_A01: '팅요금 선물을 차단하시겠습니까? \n차단 시에는 팅요금 선물을 할 수 없습니다.',
  TING_A02: '차단 해제는 지점/대리점/고객센터(국번없이 1599-0011(유료), 휴대폰 114)에서만 가능합니다.',
  TING_A03: '팅요금 선물 차단 해제 후 이용해 주세요. \n차단 해제는 지점/대리점/고객센터(국번없이 1599-0011(유료), 휴대폰 114)에서만 가능합니다.',
  ...
  TING_A10: '입력하신 번호의 휴대폰은 팅요금 선물을 할 수 없는 단말기 입니다. \n다른 분에게 조르기 신청을 해주시기 바랍니다.',
...
Tw.MSG_AUTH = {
  ...
  LINE_A01: '선택하신 회선을 첫 번째 순서로 지정하시겠습니까?',
  LINE_A11: '첫 번째 순서가 변경 되었습니다.',
  LINE_A21: '선택하신 회선을 사용 가능 회선 목록으로 이동 시 회선관리 목록에서 삭제됩니다. <br />삭제 후 다시 사용하시려면 직접 등록하셔야 가능합니다.',
  LINE_A22: '변경 내용을 저장하시겠습니까?',
  LINE_A31: '휴대폰 번호를 입력해 주세요.',
  LINE_A32: '법인명을 입력해 주세요.',
  LINE_A33: '법인번호를 입력해 주세요.',
  LINE_A41: 'SK텔레콤 이동전화번호가 아니거나 입력하신 정보가 일치하지 않습니다. 다시 입력해 주세요.',
  ...
  CERT_01: '재전송 제한시간(1분)이 지난 후에 이용해 주세요.',
  CERT_02: '제한시간 내 인증번호를 보낼 수 있는 횟수가 넘었습니다.',
  CERT_03: '인증번호가 일치하지 않습니다.',
  CERT_04: '인증번호 입력 시간이 초과했습니다.',
  CERT_05: '회원정보에 등록된 이메일이 아닙니다.',
  EXIT: '인증 페이지가 종료됩니다.'
};
...
Tw.DATE_FORMAT = {
  ...
  YYYYMMDD_TYPE_0: 'YYYY.MM.DD',
  YYYYMMDD_TYPE_1: 'YYYY-MM-DD'
};
