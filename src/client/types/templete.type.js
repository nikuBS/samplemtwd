  ...
  CUSTOMER_AGENTSEARCH_LOCATION: [
    {
      list: [
        ...
        { 'label-attr': 'id="5"', 'radio-attr': 'id="5" name="r2" data-location="광주/전남/전북/대전/충남/충북/세종"', txt: '광주/전남/전북/대전/충남/충북/세종' },
  ...
  IMMEDIATELY_CHARGE_DATA: {
    ...
    PREPAY: {
      ...
      'list': [
        ...
        { 'option': 's_data_coupon', 'button-attr': 'type="button"" target="_blank"', 'icon': 'tod-ico01', 'txt': 'T단기데이터 등록' },
