...
Tw.CommonMemberLoginRoute.prototype = {
  ...
  _successLogin: function (target, type, resp) {
    ...
    if ( resp.code === Tw.API_CODE.CODE_00 ) {
      ...
      this._historyService.goLoad('/en/common/tid/logout?type=' + Tw.TID_LOGOUT.EXCEED_FAIL + '&errorCode=' + resp.code);
      ...
      this._historyService.goLoad('/en/common/tid/logout?type=' + Tw.TID_LOGOUT.LOGIN_FAIL + '&errorCode=' + resp.code);
