...
export const API_CMD = {
  ...
  BFF_01_0069: { path: '/core-modification/:version/preference-property', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
  // AUTH
  ...
  BFF_08_0086: { path: '/core-modification/:version/ifaq/iFaq-brws-cnt-incre', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  ...
  // 영문화 신규 API추가
  BFF_05_0223: { path: '/core-bill/:version/global-hotbills', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
  BFF_05_0224: { path: '/core-product/:version/services/wireless/global-plans', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true},
  BFF_05_0225: { path: '/:version/my-t/global-balances', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true, native: true, store: true },
  BFF_05_0226: { path: '/core-bill/:version/global-bill-pay/bills' , method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
  BFF_05_0229: { path: '/core-bill/:version/global-bill-pay/bills-submain', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },

  BFF_10_0202_EN: { path: '/core-product/:version/submain/global-grpprods', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
...
export const API_CODE = {
  ...
  NODE_1009: '1009',  // (만 19세 미만 미성년자에 대한 문구) 고객센터를 통해 예약 가능합니다.
  NODE_1010: '1010',  // 14세 미만 API 조회 후 빈값일때, 이용에 불편을 드려서 죄송합니다.

  NODE_1011: '1011',  // 진행중인 설문/투표/퀴즈가 아닙니다.
  NODE_1012: '1012',  // 존재하는 설문/투표/퀴즈가 아닙니다.
...
// 영문 코드 
export const API_EN_CODE = {
  BFF_05_0223: 'BFF_05_0223',
  BFF_05_0224: 'BFF_05_0224', // MU1 글로벌 무선 나의 가입정보 조회
  BFF_05_0225: 'BFF_05_0225',
