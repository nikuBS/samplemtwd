...
export const MYT_DATA_USAGE = {
  ...
  ERROR: {
    DEFAULT_TITLE: 'Data balance not available',
    DEFAULT_CONTENT: 'Data balance not available',
    BLN0001: {
      title: 'Please try again later',
      contents: 'The number of inquiries permitted is limited to ensure service stability.'
    },
    BLN0002: {
      title: 'Data balance not available',
      contents: 'You have just switched back to your current plan within the past month.'
    },
    BLN0003: {
      title: 'Data balance not available',
      contents: 'You have suspended your service within the past month.'
    },
    BLN0004: {
      title: 'Data balance not available',
      contents: 'No data balance information available.'
    },
    BLN0005: {
      title: 'Data balance not available',
      contents: 'You are not the legal guardian of the subscriber.'
    },
    BLN0006: {
      title: 'Data balance not available',
      contents: 'Data balance could not be found.'
    },
    BLN0007: {
      title: 'Data balance not available',
      contents: 'No data balance information available.'
