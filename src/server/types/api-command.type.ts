...
export const API_CMD = {
  ...
  BFF_07_0078: { path: '/core-bill/v1/useContentsPrepay/useContentsPrepay-hist-requests', method: API_METHOD.GET,
  ...
  BFF_08_0008: { path: '/core-modification/v1/region-close-store-list', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: false },
