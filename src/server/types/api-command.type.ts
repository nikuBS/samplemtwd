...
export const API_CMD = {
  ...
  BFF_03_0016: { path: '/core-auth/v1/service-passwords', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: false},
  BFF_03_0017: { path: '/user/login/android', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  BFF_03_0018: { path: '/user/login/ios', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  ...
  BFF_05_0011: { path: '/core-balance/v1/data-sharings', method: API_METHOD.DELETE, server: API_SERVER.BFF, bypass: true },
  ...
  BFF_07_0071: { path: '/core-bill/v1/microPrepay-hist-requests', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: false },
  BFF_07_0072: { path: '/core-bill/v1/microPrepay-hist-requests', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: false },
  BFF_07_0073: { path: '/core-bill/v1/microPrepay-requests', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
  BFF_07_0074: { path: '/core-bill/v1/microPrepay', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  BFF_07_0075: { path: '/core-bill/v1/microPrepay-autolist', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: false },
  BFF_07_0076: { path: '/core-bill/v1/microPrepay-auto-req', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  BFF_07_0077: { path: '/core-bill/v1/microPrepay-auto-delete', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  BFF_07_0078: { path: '/core-bill/v1/useContentsPrepay-hist-requests', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: false },
  BFF_07_0079: { path: '/core-bill/v1/useContentsPrepay-autolist', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: false },
  BFF_07_0080: { path: '/core-bill/v1/useContentsPrepay-autolist', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: false },
  BFF_07_0081: { path: '/core-bill/v1/useContentsPrepay-requests', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
