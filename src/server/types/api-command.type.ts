...
export const API_CMD = {
  ...
  BFF_01_0026: { path: '/cert/success', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true, native: true },
  ...
  BFF_01_0029: { path: '/core-auth/v1/app-secure', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true, native: true },
  BFF_01_0030: { path: '/core-auth/v1/server-cert', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true, native: true },
  BFF_01_0031: { path: '/fido/registration-request', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true, native: true },
  BFF_01_0032: { path: '/fido/registration-response', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true, native: true },
  BFF_01_0033: { path: '/fido/authentication-request', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true, native: true },
  BFF_01_0034: { path: '/fido/authentication-response', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true, native: true },
