...
export const API_CMD = {
  ...
  BFF_05_0176: { path: '/core-bill/v1/micro-pay/requests-limit-down', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: false },
  BFF_05_0177: { path: '/core-bill/v1/use-contents/limit-down', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: false },
