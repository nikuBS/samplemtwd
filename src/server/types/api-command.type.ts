...
export const API_CMD = {
  ...
  BFF_01_0002: { path: '/common/sessions', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true, native: true },
  ...
  BFF_01_0005: { path: '/common/selected-sessions', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: false, native: true },
  ...
  BFF_01_0035: { path: '/cert/app', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true, native: true },
  BFF_01_0036: { path: '/cert/info', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true, native: true },
  ...
  BFF_01_0039: { path: '/bpcp', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: false },
  ...
  BFF_03_0006: { path: '/user/nick-names/:args0', method: API_METHOD.PUT, server: API_SERVER.BFF, bypass: true },
  BFF_03_0007: { path: '/user/tid-keys', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true, native: true },
  BFF_03_0008: { path: '/user/sessions', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: false, native: true },
  ...
  BFF_05_0186: { path: '/core-modification/v1/numberChangeInit', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: false },
  ...
  BFF_07_0023: { path: '/payment/settle-pay-bank', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  BFF_07_0024: { path: '/core-bill/v1/bill-pay/cardnum-validation', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
  BFF_07_0025: { path: '/payment/settle-pay-card', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
