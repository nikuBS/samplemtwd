...
export const API_CMD = {
  ...
  BFF_01_0057: { path: '/v1/auth/skt-sms/representative', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  BFF_01_0058: { path: '/v1/auth/skt-sms/legal-agent', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  BFF_01_0061: { path: '/core-auth/v1/user-email', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
  ...
  // MainHome T-Notify
  BFF_04_0001: { path: '/core-membership/v1/card/homeinfo', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
  ...
  BFF_05_0013: { path: '/core-bill/v1/pps-card', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: false },
  ...
  BFF_05_0064: { path: '/core-bill/v1/use-contents/hist-requests', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
  BFF_05_0066: { path: '/core-bill/v1/use-contents/limit-requests', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
  BFF_05_0067: { path: '/core-bill/v1/use-contents/limit-up', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  ...
  BFF_05_0079: { path: '/core-bill/v1/micro-pay/hist-requests', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  BFF_05_0080: { path: '/core-bill/v1/micro-pay/requests', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
  BFF_05_0081: { path: '/core-bill/v1/micro-pay/requests', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  BFF_05_0082: { path: '/core-bill/v1/micro-pay/auto-set', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  BFF_05_0083: { path: '/core-bill/v1/micro-pay/requests', method: API_METHOD.PUT, server: API_SERVER.BFF, bypass: true },
  BFF_05_0085: { path: '/core-bill/v1/micro-pay/password-status', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
  BFF_05_0086: { path: '/core-bill/v1/micro-pay/password-create', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  BFF_05_0087: { path: '/core-bill/v1/micro-pay/password-changes', method: API_METHOD.PUT, server: API_SERVER.BFF, bypass: true },
  ...
  BFF_05_0093: { path: '/core-bill/v1/micro-pay/cphist-requests', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
  ...
  BFF_05_0144: {
    path: '/core-product/v1/services/combinations/:args0/terminations',
  ...
  BFF_05_0176: { path: '/core-bill/v1/micro-pay/requests-limit-down', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  BFF_05_0177: { path: '/core-bill/v1/use-contents/limit-down', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  ...
  BFF_06_0051: { path: '/core-recharge/v1/tfamily-sharing-limitations/:args0', method: API_METHOD.DELETE, server: API_SERVER.BFF, bypass: true },
  ...
  BFF_06_0069: { path: '/core-bill/v1/pps-recharges', method: API_METHOD.DELETE, server: API_SERVER.BFF, bypass: true },
  BFF_06_0070: { path: '/core-bill/v1/pps-data-recharges', method: API_METHOD.DELETE, server: API_SERVER.BFF, bypass: true },
  ...
  BFF_07_0075: { path: '/core-bill/v1/micro-prepay/auto-list', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: false },
  BFF_07_0076: { path: '/core-bill/v1/micro-prepay/auto-process', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  BFF_07_0077: { path: '/core-bill/v1/micro-prepay/auto-delete', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  BFF_07_0078: { path: '/core-bill/v1/use-contents-prepay/hist-requests', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
  BFF_07_0079: { path: '/core-bill/v1/use-contents-prepay/auto-hist', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
  BFF_07_0080: { path: '/core-bill/v1/use-contents-prepay/auto-prepay-status', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: false },
  BFF_07_0081: { path: '/core-bill/v1/use-contents-prepay/requests', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
  BFF_07_0082: { path: '/core-bill/v1/use-contents-prepay/process', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  BFF_07_0083: { path: '/core-bill/v1/use-contents-prepay/auto-process', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  BFF_07_0084: { path: '/core-bill/v1/use-contents-prepay/auto-delete', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  BFF_07_0085: { path: '/core-bill/v1/use-contents-prepay/auto-prepay-amt', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: false },
  BFF_07_0086: { path: '/core-bill/v1/micro-prepay/auto-prepay-amt', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: false },
  ...
  BFF_07_0093: { path: '/core-bill/v1/point-onetime-histories', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: false },
  BFF_07_0094: { path: '/core-bill/v1/point-autopay-histories', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: false },
  ...
  BFF_08_0064: { path: '/core-modification/v1/guide/contents-detail/:args0', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
  BFF_08_0065: { path: '/core-modification/v1/guide/contents-view-count-up/:args0', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: true },
  BFF_08_0066: { path: '/core-modification/v1/center/banner', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
  BFF_08_0069: { path: '/core-modification/v1/search/invst-list', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
  ...
  BFF_10_0007: {
    path: '/core-product/v1/mobiles/fee-plans/:args0/joins/join-prechecks',
  ...
  BFF_10_0066: { path: '/core-product/v1/roaming/tpie-reservation', method: API_METHOD.PUT, server: API_SERVER.BFF, bypass: true },
  ...
  BFF_11_0010: { path: '/core-membership/v1/card/hist', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
  ...
  BFF_11_0017: { path: '/core-membership/v1/tmembership/brand-list', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
  ...
  BFF_11_0025: { path: '/core-membership/v1/tmembership/near-brand', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
