...
export const API_CMD = {
  ...
  BFF_01_0014: { path: '/core-auth/v1/auth/skt/sms', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: false },
  BFF_01_0015: { path: '/auth/skt/sms-authentication', method: API_METHOD.PUT, server: API_SERVER.BFF, bypass: false },
  BFF_01_0016: { path: '/core-auth/v1/auth/dca/sms', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: false },
  BFF_01_0017: { path: '/core-auth/v1/auth/email', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: false },
  BFF_01_0018: { path: '/auth/email-authentication', method: API_METHOD.PUT, server: API_SERVER.BFF, bypass: false },
  BFF_01_0019: { path: '/auth/motp/apply', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: false },
  BFF_01_0020: { path: '/auth/motp/auth', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: false },
  BFF_01_0021: { path: '/core-auth/v1/auth/motp', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: false },
  BFF_01_0022: { path: '/auth/nice/ipin/apply', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: false },
  BFF_01_0023: { path: '/auth/nice/ipin/result', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: false },
  BFF_01_0024: { path: '/auth/nice/sms/apply', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: false },
  BFF_01_0025: { path: '/auth/nice/sms', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: false },
  BFF_01_0026: { path: '/cert/success', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: false },
  BFF_01_0027: { path: '/pwd-cert-chk', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: false },
  BFF_01_0028: { path: '/core-auth/v1/auth/skt/sms-finance', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: false },
  BFF_01_0029: { path: '/core-auth/v1/app-secure', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: false },
  BFF_01_0030: { path: '/core-auth/v1/server-cert', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: false },
  // AUTH
  ...
  BFF_05_0101: { path: '/core-bill/v1/rainbow-point-services', method: API_METHOD.GET, server: API_SERVER.BFF, bypass: true },
  ...
  BFF_08_0050: { path: '/core-modification/v1/ifaq/iFaqList', method: API_METHOD.POST, server: API_SERVER.BFF, bypass: false },
