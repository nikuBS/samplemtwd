...
export const TOTAL_SHARE_DATA_SKIP_ID = [
  ...
  // 신규 다이렉트 플랜 결합 상품 추가
  'DDP73',  // NA00006999	5GX플래티넘+다이렉트플랜	통합공유 데이터 50GB
  'DDP49',  // NA00007001	5GX프라임+다이렉트플랜	통합공유 데이터 30GB
  'DDP31',  // NA00007002	5GX스탠다드+다이렉트플랜	통합공유 데이터 20GB
  'DDPE3',  // NA00007004	T플랜 맥스+다이렉트플랜 통합공유 데이터 40GB
  'DDPD1',  // NA00007005	T플랜 스페셜+다이렉트플랜	통합공유 데이터 20GB
  'DDPC0'   // NA00007006	T플랜 에센스+다이렉트 플랜	통합공유 데이터 15GB
];
