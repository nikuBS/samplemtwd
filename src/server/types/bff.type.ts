...
export enum PRODUCT_RESERVATION_REJECT {
  R176 = '가족관계 입증이 가능한 서류를 제출해주세요.',
  R01 = '서류에서 신청하신 가족 정보를 확인할 수 없습니다.\n가족관계 입증이 가능한 서류를 제출해주세요.',
  R02 = '서류에서 신청하신 가족 정보를 식별할 수 없습니다.\n가족관계 식별이 가능한 서류를 제출해주세요.',
  R03 = '개명(개칭) 확인이 가능한 서류를 제출해주세요.',
  R04 = '가족간 명의변경 및 주민(법인,외국인)등록번호 정정내용 \n확인이 가능한 서류(행정기관 발급용)를 제출해주세요.',
  R05 = '구비서류 제출기한을 초과하였습니다.\n(제출기한 : nextDistbDt)',
  R06 = '본인 이외 타인의 서류는 제출이 불가능합니다.\n자세한 상담은 SK텔레콤 전문 상담원(114)에게 문의해주세요.',
