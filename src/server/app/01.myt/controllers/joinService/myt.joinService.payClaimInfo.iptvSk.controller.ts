...
class MytJoinServicePayClaimInfoIptvSk extends TwViewController {
  constructor() {
    super();
  }
  ...
  private _urlTplInfo: any = {
    pageRenderView: 'joinService/myt.joinService.payClaimInfo.iptvSk.html'
  };
...
export default MytJoinServicePayClaimInfoIptvSk;
