...
class MytJoinServiceContractTerminalInfoTloginDetailController extends TwViewController {
  constructor() {
    super();
  }
...
export default MytJoinServiceContractTerminalInfoTloginDetailController;
