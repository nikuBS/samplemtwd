...
class MytJoinServiceContractTerminalInfoPhoneDetail extends TwViewController {
  constructor() {
    super();
  }
  ...
  private _urlTplInfo:any = {
    pageRenderView:  'joinService/myt.joinService.contractTerminalInfo.phone.detail.html'
  };
...
export default MytJoinServiceContractTerminalInfoPhoneDetail;
