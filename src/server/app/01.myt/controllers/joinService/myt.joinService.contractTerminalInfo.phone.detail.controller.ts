...
class MytJoinServiceContractTerminalInfoPhoneDetailController extends TwViewController {
  constructor() {
    super();
  }
...
export default MytJoinServiceContractTerminalInfoPhoneDetailController;
