...
class MytJoinContractTerminalTwibro extends TwViewController {
  constructor() {
    super();
  }
  ...
  private _urlTplInfo: any = {
    pageRenderView: 'join/myt.join.contract-terminal.twibro.html'
  };
...
export default MytJoinContractTerminalTwibro;
