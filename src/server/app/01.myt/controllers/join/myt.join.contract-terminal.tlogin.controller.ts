...
class MytJoinContractTerminalTlogin extends TwViewController {
  constructor() {
    super();
  }
  ...
  private _urlTplInfo: any = {
    pageRenderView: 'join/myt.join.contract-terminal.tlogin.html'
  };
...
export default MytJoinContractTerminalTlogin;
