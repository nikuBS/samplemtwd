...
class MytJoinContractTerminalPhoneDetail extends TwViewController {
  constructor() {
    super();
  }
  ...
  private _urlTplInfo: any = {
    pageRenderView: 'join/myt.join.contract-terminal.phone.detail.html'
  };
...
export default MytJoinContractTerminalPhoneDetail;
