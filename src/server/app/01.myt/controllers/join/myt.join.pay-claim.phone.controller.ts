/**
 * FileName: myt.joinService.payClaimInfo.phone.controller
...
class MytJoinPayClaimPhone extends TwViewController {
  constructor() {
    super();
  }
  ...
  private _urlTplInfo: any = {
    pageRenderView: 'join/myt.join.pay-claim.phone.html'
  };
...
export default MytJoinPayClaimPhone;
