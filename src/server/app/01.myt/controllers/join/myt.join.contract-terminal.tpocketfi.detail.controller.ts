...
class MytJoinContractTerminalTpocketfiDetail extends TwViewController {
  constructor() {
    super();
  }
  ...
  private _urlTplInfo: any = {
    pageRenderView: 'join/myt.join.contract-terminal.tpocketfi.detail.html'
  };
...
export default MytJoinContractTerminalTpocketfiDetail;
