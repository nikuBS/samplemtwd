...
class MytUsageCombineWithMineController extends TwViewController {
  ...
  render(req: Request, res: Response, next: NextFunction, svcInfo: any) {
    Observable.combineLatest(
      ...
      this.myTUsage.renderView(res, 'usage/myt.usage.combine-with-mine.html', this.getData(usageData, svcInfo));
    });
  }
...
export default MytUsageCombineWithMineController;
