...
class MyTJoinProductService extends TwViewController {
  ...
  private _convertFeePlan(data, isWire): Observable<any> {
    ...
    return Object.assign(data.result, {
      feePlanProd: Object.assign(data.result.feePlanProd, {
        ...
        basFeeTxt: isNaN(parseInt(data.result.feePlanProd.basFeeTxt, 10))
      ...
      tClassProd: {
        tClassProdList:
          data.result.tClassProd && data.result.tClassProd.tClassProdList
  ...
  render(req: Request, res: Response, next: NextFunction, svcInfo: any) {
    ...
    Observable.combineLatest(this.apiService.request(apiInfo.apiCmd, {}), this.getCombinations(), this.getAdditions(svcInfo)).subscribe(
      ([feePlan, combinations, additions]) => {
  ...
  private getCombinations = (): Observable<ICombination[] | null> => {
    return this.apiService
      .request(API_CMD.BFF_05_0133, {})
      .map((resp: { code: string; result: { combinationWireMemberList?: any[]; combinationWirelessMemberList?: any[] } }) => {
