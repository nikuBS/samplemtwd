/**
 * FileName: customer.event.detail.controller.ts
...
class CustomerEventDetailController extends TwViewController {
  ...
  render(req: Request, res: Response, next: NextFunction, svcInfo?: any): void {
    ...
    this.apiService.request(API_CMD.BFF_09_0002, { prNum: id }).subscribe((resp) => {
      if (resp.code === API_CODE.CODE_00) {
        res.render('event/customer.event.detail.html', {
