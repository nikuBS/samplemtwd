/**
 * FileName: customer.svc-info.notice.directshop.controller.ts
...
class CustomerSvcInfoNoticeDirectshop extends TwViewController {
  constructor() {
    super();
  }
  ...
  render(req: Request, res: Response, next: NextFunction, svcInfo: any, allSvc: any, childInfo: any, pageInfo: any) {
    ...
    this.apiService.request(API_CMD.BFF_08_0039, { page: 0, size: 20 })
      .subscribe((data) => {
        ...
        res.render('svc-info/customer.svc-info.notice.html', Object.assign(renderCommonInfo, {
          category: 'directshop',
          categoryLabel: CUSTOMER_NOTICE_CATEGORY.DIRECTSHOP,
...
export default CustomerSvcInfoNoticeDirectshop;
