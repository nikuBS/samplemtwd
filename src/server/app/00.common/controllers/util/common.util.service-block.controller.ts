  ...
  render(req: Request, res: Response, next: NextFunction, svcInfo: any, pageInfo: any) {
    ...
    this.apiService.request(API_CMD.BFF_01_0069, DEFAULT_PARAM).subscribe((resp) => {
      if ( resp.code === API_CODE.CODE_00 ) {
        // Y|202008220000|202008310000|코로나19인해 고객센터 사옥 폐쇄 안내드립니다.|<div class=\"wrap checking_wrap\">    <i class=\"icon-warning-120\"><span class=\"blind\">warning</span></i>    <p class=\"tit\">시스템 점검 중입니다</p>    <p class=\"txt\">이용에 불편을 드려 죄송합니다.<br>더욱 편리하고 안정된 서비스를 제공하기 위해<br>T world 시스템을 점검하고 있습니다.</p>    &lt;% if (hideTime) { %&gt;    <p class=\"subTxt\">&lt;%= fromDtm %&gt; ~ &lt;%= toDtm %&gt;</p>    &lt;% } %&gt;</div>
