...
class MyTJoinWireHistoryDetail extends TwViewController {
  ...
  render(req: Request, res: Response, next: NextFunction, svcInfo: any, allSvc: any, childInfo: any, pageInfo: any) {
    ...
    switch (atype) {
      case MyTJoinWireHistory._ATYPE_143:   // 유선 약정기간 상세내역
        apiCmd = API_CMD.BFF_05_0143;
        break;
      case MyTJoinWireHistory._ATYPE_153:   // 요금상품변경 상세내역
        apiCmd = API_CMD.BFF_05_0153;
        break;
      case MyTJoinWireHistory._ATYPE_162:   // 설치장소변경상세
        apiCmd = API_CMD.BFF_05_0162;
        break;
      case MyTJoinWireHistory._ATYPE_167:   // 신규가입상세내역
        apiCmd = API_CMD.BFF_05_0167;
        break;
      case MyTJoinWireHistory._ATYPE_168:   // 가입상품변경 상세내역
