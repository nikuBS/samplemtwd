 ...
 * @class
 */
class ProductMobileplanAddLookupSilverNoti extends TwViewController {
  constructor() {
    super();
  }
  ...
  render(req: Request, res: Response, next: NextFunction, svcInfo: any, allSvc: any, childInfo: any, pageInfo: any) {
    ...
    this.apiService.request(API_CMD.BFF_10_0021, {}, {}, [prodId])
      .subscribe((paymentInfo) => {
        ...
        res.render('mobileplan-add/lookup/product.mobileplan-add.lookup.silver-noti.html', Object.assign(renderCommonInfo, {
...
export default ProductMobileplanAddLookupSilverNoti;
