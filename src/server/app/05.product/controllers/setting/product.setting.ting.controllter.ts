/**
 * 모바일 요금제 > 데이터 상한금액 설정
 * FileName: product.setting.ting.controller.ts
...
class ProductSettingTing extends TwViewController {
  constructor() {
    super();
  }
  ...
  render(req: Request, res: Response, next: NextFunction, svcInfo: any, allSvc: any, childInfo: any, pageInfo: any) {
    ...
    this.apiService.request(API_CMD.BFF_10_0040, {}, {}, prodId)
      .subscribe((tingInfo) => {
        ...
        res.render('setting/product.setting.ting.html', Object.assign(renderCommonInfo, {
          prodId: prodId,
...
export default ProductSettingTing;
