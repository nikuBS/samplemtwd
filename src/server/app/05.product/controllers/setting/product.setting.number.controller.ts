/**
 * 모바일 요금제 > 지정할인
 * FileName: product.setting.number.controller.ts
...
class ProductSettingNumber extends TwViewController {
  constructor() {
    super();
  }
  ...
  render(req: Request, res: Response, next: NextFunction, svcInfo: any, allSvc: any, childInfo: any, pageInfo: any) {
    ...
    this.apiService.request(API_CMD.BFF_10_0073, {}, {})
      .subscribe((numberInfo) => {
        ...
        res.render('setting/product.setting.number.html', Object.assign(renderCommonInfo, {
          prodId: prodId,
...
export default ProductSettingNumber;
