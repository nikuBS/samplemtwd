/**
 * 상품 가입 - 모바일 부가서비스
 * FileName: product.join.mobileplan-add.controller.ts
...
class ProductJoinMobileplanAdd extends TwViewController {
  constructor() {
    super();
  }
    ...
    Observable.combineLatest(
      ...
      this.apiService.request(API_CMD.BFF_10_0017, { joinTermCd: '01' }, {}, prodId)
        .subscribe((joinTermInfo) => {
          ...
          res.render('join/product.join.mobileplan-add.html', Object.assign(renderCommonInfo, {
            prodId: prodId,
...
export default ProductJoinMobileplanAdd;
