/**
 * FileName: product.join.signature-line.controller.ts
...
class ProductJoinSignatureLine extends TwViewController {
  constructor() {
    super();
  }
  ...
  render(req: Request, res: Response, next: NextFunction, svcInfo: any, allSvc: any, childInfo: any, pageInfo: any) {
    ...
    this.apiService.request(API_CMD.BFF_05_0133, {}).subscribe((currentCombineInfo) => {
      ...
      Observable.combineLatest(
        ...
        res.render('join/product.join.signature-line.html', Object.assign(renderCommonInfo, {
          prodId: prodId,
...
export default ProductJoinSignatureLine;
