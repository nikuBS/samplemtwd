/**
 * FileName: payment.prepay.micro.auto.change.controller.ts
...
class PaymentPrepayMicroAutoChangeController extends TwViewController {
  constructor() {
    super();
  }
  ...
  render(req: Request, res: Response, next: NextFunction, svcInfo: any) {
    Observable.combineLatest(
      ...
      if (autoPrepayInfo.code === API_CODE.CODE_00) {
        res.render('payment.prepay.micro.auto.change.html', {
  ...
  private getAutoPrepayInfo(): Observable<any> {
    return this.apiService.request(API_CMD.BFF_07_0086, {}).map((res) => {
      return res;
    });
  }
...
export default PaymentPrepayMicroAutoChangeController;
