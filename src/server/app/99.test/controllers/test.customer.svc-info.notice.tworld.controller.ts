/**
 * FileName: test.customer.svc-info.notice.tworld.controller.ts
...
class TestCustomerSvcInfoNoticeTworld extends TwViewController {
  constructor() {
    super();
  }
  ...
  render(req: Request, res: Response, next: NextFunction, svcInfo: any, allSvc: any, childInfo: any, pageInfo: any) {
    ...
    this.apiService.request(API_CMD.BFF_08_0029_TEST, { expsChnlCd: 'M', page: 0, size: 20 })
      .subscribe((data) => {
...
export default TestCustomerSvcInfoNoticeTworld;
