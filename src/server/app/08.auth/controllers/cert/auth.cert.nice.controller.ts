/**
 * FileName: auth.cert.nice.controller.ts
...
class AuthCertNice extends TwViewController {
  constructor() {
    super();
  }
  ...
  render(req: Request, res: Response, next: NextFunction, svcInfo: any) {
    ...
    this.apiService.request(API_CMD.BFF_01_0024, {
      ...
      if ( resp.code === API_CODE.CODE_00 ) {
        res.render('cert/auth.cert.nice.html', { data: resp.result });
      }
    });
  }
}

export default AuthCertNice;
