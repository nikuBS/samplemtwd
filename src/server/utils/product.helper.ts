...
class ProductHelper {
   ...
   */
  static _getLineProcessCase(prodTypCd: any, allSvc?: any, svcAttrCd?: any): any {
   ...
   */
  static _getAllowedSvcAttrCd(prodTypCd: any): any {
   ...
   */
  static _getAllowedLineLength(svcAttrCds: any, svcGroupList: any): any {
    let length: any = 0;
