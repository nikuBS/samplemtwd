...
import { TERM_STRING } from '../../../../../types_en/string.type';
...
export default class MainMenuSettingsTerms extends TwViewController {
  ...
  render(req: Request, res: Response, next: NextFunction, svcInfo: any,
    ...
    if (req.query.id) {
      ...
      if (id === '102') { // 초콜릿 이용약관
        res.render('menu/settings/en.main.menu.settings.terms.choco.html', {
          svcInfo, pageInfo
        });
      }
      ...
      if (!!url) {
        ...
        res.render(`menu/settings/en.main.menu.settings.term-type-${req.query.type}.html`, {
      ...
      res.render('menu/settings/en.main.menu.settings.terms.html', { svcInfo, pageInfo });
    }
  }
