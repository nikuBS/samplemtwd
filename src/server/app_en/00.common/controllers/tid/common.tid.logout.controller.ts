...
import { TID_LOGOUT } from '../../../../types_en/common.type';
import { TID_MSG } from '../../../../types_en/string.type';
...
class CommonTidLogout extends TwViewController {
  ...
  render(req: Request, res: Response, next: NextFunction, svcInfo: any, allSvc: any, childInfo: any, pageInfo: any) {
    ...
    const routeUrl = type === TID_LOGOUT.LOGIN_FAIL ? '/en/common/member/login/fail?errorCode=' + errorCode :
      type === TID_LOGOUT.EXCEED_FAIL ? '/en/common/member/login/exceed-fail' : '/en/common/member/logout/complete';
    let clientId = '';
