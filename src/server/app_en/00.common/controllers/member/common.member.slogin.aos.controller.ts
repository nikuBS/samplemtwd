...
class CommonMemberSloginAos extends TwViewController {
  ...
  render(req: Request, res:
    ...
    if ( FormatHelper.isEmpty(mdnQuery) ) {
      res.render('member/en.common.member.slogin.aos.html', { svcInfo, pageInfo, mdn: null, target });
      ...
      res.render('member/en.common.member.slogin.aos.html', { svcInfo, pageInfo, mdn, target });
    }
  }
}
