...
import { LINE_NAME, SVC_ATTR_E, SVC_ATTR_NAME, SVC_CD_ICO_CLASS, SVC_CATEGORY } from '../../../../types_en/bff.type';
import DateHelper from '../../../../utils_en/date.helper';
import { DEFAULT_LIST_COUNT } from '../../../../types_en/config.type';
...
class CommonMemberLine extends TwViewController {
  ...
  render(req: Request, res: Response, next: NextFunction, svcInfo: any, allSvc: any, childInfo: any, pageInfo: any) {
    ...
    ]).subscribe(([mobile, exposed]) => {
      if ( mobile.code === API_CODE.CODE_00 ) {
        if ( mobile.result.totalCnt === '0' || mobile.result.mCnt === '0' ) {
          res.render('member/en.common.member.line.empty.html', { svcInfo, pageInfo });
        } else {
          ...
          res.render('member/en.common.member.line.html', Object.assign(lineInfo, {
            svcInfo, pageInfo
          }));
        }
