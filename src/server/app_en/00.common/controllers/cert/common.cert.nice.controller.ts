...
class CommonCertNice extends TwViewController {
  ...
  render(req: Request, res: Response, next: NextFunction, svcInfo: any, allSvc: any, childInfo: any, pageInfo: any) {
    ...
    this.apiService.request(API_CMD.BFF_01_0024, {
      mobileco,
      authUrl,
      resultUrl:  'https://' + this.loginService.getDns(req) + '/en/common/cert/result?type=nice&kind=' + authKind,
      ...
      if ( resp.code === API_CODE.CODE_00 ) {
        ...
        res.redirect('/en/common/inapp/error?code=' + resp.code + '&msg=' + resp.msg);
      }
    });
  }
}
